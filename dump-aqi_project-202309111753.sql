...
CREATE TABLE `between_account_and_status` (
  ...
  CONSTRAINT `FK76dkl4agcjx0xa15keue4mhv1` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`),
...
CREATE TABLE `bookmark` (
  ...
  KEY `FKgiqgu6u1n6x6dtdwxtlkarj34` (`user_account_id`),
  CONSTRAINT `FK2n4f1mb3dspbiv7fyp018lmhw` FOREIGN KEY (`forecast_type_id`) REFERENCES `forecast_type` (`id`),
  CONSTRAINT `FKgiqgu6u1n6x6dtdwxtlkarj34` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `message` (
  ...
  KEY `FK6cpl7pmmjhpu5ui662u9te3yk` (`user_account_id`),
  CONSTRAINT `FK6cpl7pmmjhpu5ui662u9te3yk` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`),
...
CREATE TABLE `reaction` (
  ...
  KEY `FK1cj1cuvsoi8vhgcfujbeumdyd` (`user_account_id`),
  CONSTRAINT `FK1cj1cuvsoi8vhgcfujbeumdyd` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`),
...
CREATE TABLE `thread` (
  ...
  KEY `FKoad0k1jwmcgw37libe1e6fcrk` (`user_account_id`),
  CONSTRAINT `FKkpxdvhiu73mdmtkrieddk3tpa` FOREIGN KEY (`topic_id`) REFERENCES `topic` (`id`),
  CONSTRAINT `FKoad0k1jwmcgw37libe1e6fcrk` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `topic` (
  ...
  `title` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKc0lniglwft2e0e8jgsuncnw80` (`user_account_id`),
  CONSTRAINT `FKc0lniglwft2e0e8jgsuncnw80` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-11 17:53:20
