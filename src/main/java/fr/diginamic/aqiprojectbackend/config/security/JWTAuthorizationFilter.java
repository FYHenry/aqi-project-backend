...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
     ...
     *    - set a role from Srting format to list format since UsernamePasswordAuthenticationToken can only read lists of roles
     *  @param role : user role (from token) as a String.
     *  @returns  Collection of roles: user role (from token) as a list
     */
